		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				.dataTable( {
				   ...
				   "sAjaxSource": "${ctx}/sys/dict/datatables", //给服务器发请求的url
				   ...
				   "aoColumns": [ //这个属性下的设置会应用到所有列，按顺序没有是空
				                    ...
				                    {"mData": 'value',"bSortable":false}, // sDefaultContent 如果这一列不需要填充数据用这个属性，值可以不写，起占位作用
				                    {"mData": 'label'},
				                    {"mData": 'type'},
				                    {"mData": 'sort'},
				                    {"mData": 'description'},
				     ...
				     "aoColumnDefs":[
				                     ...
				                     },
				                     {
		                            	 ...
		                            	 "mRender": function(data, type, full) { // 返回自定义内容
		                            		...
		                            		html += "<a title='添加' data-rel='tooltip' class='blue' href='${ctx}/sys/dict/add?id=" + data + "' ><i class='ace-icon fa fa-plus-square-o bigger-130'></i></a>";
		                            		html += "<a title='修改' data-rel='tooltip' class='green' href='${ctx}/sys/dict/form?id=" + data + "' ><i class='ace-icon fa fa-pencil-square-o bigger-130'></i></a>";
		                            		html += "<a title='删除' data-rel='tooltip' class='red' href='${ctx}/sys/dict/delete?id=" + data + "' onclick='return confirmx(\"删除吗?\",this.href)'><i class='ace-icon fa fa-trash-o bigger-130'></i></a>";
		                            		/* html += "<a title='添加' data-rel='tooltip' class='purple' href='${ctx}/sys/dict/from?id=" + data + "' ><i class='ace-icon fa fa-search-plus bigger-130'></i></a>"; */
		                            		html += "</div>";
		                            		return html;
		                                 } 
		...
		<div class="widget-box" style="margin:0px 0px 6px 0px;">
			<div class="widget-body">
				<div class="widget-main">
					<form class="form-search" id="searchForm" action="${ctx}/sys/dict/list" method="post">
						<div class="row">
