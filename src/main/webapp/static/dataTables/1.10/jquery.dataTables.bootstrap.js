...
$.extend($.fn.dataTableExt.oPagination, {
    bootstrap: {
        fnInit: function(a, b, c) {
            ...
            $(b).append('<ul class="pagination"><li class="prev disabled"><a href="#"><i class="fa fa-angle-double-left"></i></a></li><li class="prev disabled"><a href="#"><i class="fa fa-angle-left"></i></a></li><li class="next disabled"><a href="#"><i class="fa fa-angle-right"></i></a></li><li class="next disabled"><a href="#"><i class="fa fa-angle-double-right"></i></a></li><li class="redirectli disabled"><a href="javascript:;" style="padding:4px 12px 4px 12px;"><input type="text" style="width:30px;margin:0;padding:0;text-align:center;" id="redirect" class="redirect"></a></li></ul>');
            $(b).find(".redirect").keypress(function(e){
            	var inputc=e.keyCode||e.which;
            	if(inputc==13){
            		var ipage = parseInt($(this).val());
 	                var oPaging = a.oInstance.fnPagingInfo();
 	                ...
 	                $(this).val(ipage);
 	                ipage--;
 	                a._iDisplayStart = ipage * oPaging.iLength;
 	                c( a );
            	}
        	});
            var e = $("a", b);
        ...
        fnUpdate: function(a, b) {
            ...
            for (j.iTotalPages < i ? (g = 1, h = j.iTotalPages) : j.iPage <= l ? (g = 1, h = i) : j.iPage >= j.iTotalPages - l ? (g = j.iTotalPages - i + 1, h = j.iTotalPages) : (g = j.iPage - l + 1, h = g + i - 1), c = 0, d = k.length; d > c; c++) {
                for ($("li:gt(0)", k[c]).filter(":not(.next,.prev,.redirectli)").remove(), e = g; h >= e; e++) f = e == j.iPage + 1 ? 'class="active"': "",
                $("<li " + f + '><a href="#">' + e + "</a></li>").insertBefore($("li.next:eq(0)", k[c])[0]).bind("click",
                function(c) {
                    c.preventDefault(),
                    a._iDisplayStart = (parseInt($("a", this).text(), 10) - 1) * j.iLength,
                    b(a)
                });
                0 === j.iPage ? $("li.prev", k[c]).addClass("disabled") : $("li.prev", k[c]).removeClass("disabled"),
                j.iPage === j.iTotalPages - 1 || 0 === j.iTotalPages ? $("li.next", k[c]).addClass("disabled") : $("li.next", k[c]).removeClass("disabled")
            }
        }
    }
})),
